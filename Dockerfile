...
# download gradle
RUN wget https://downloads.gradle.org/distributions/gradle-2.14.1-bin.zip
RUN mkdir -p /usr/local/gradle
RUN unzip gradle-2.14.1-bin.zip -d /usr/local/gradle
RUN rm gradle-2.14.1-bin.zip
ENV GRADLE_HOME /usr/local/gradle/gradle-2.14.1-bin.zip
